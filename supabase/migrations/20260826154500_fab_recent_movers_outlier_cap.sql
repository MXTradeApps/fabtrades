-- Omit garbage catalog Lows from recent movers.
-- Caps must match packages/contracts/recent_movers.json limits:
-- max_observed_low 10000, max_abs_percent_change 10.
...
COMMENT ON FUNCTION public.fab_recent_movers(text, text[]) IS
  'Rank recent Low movers. Eligibility, window, floor, outlier cap, and order must match packages/contracts/recent_movers.json.';
